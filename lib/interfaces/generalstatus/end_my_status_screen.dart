...
class EndMyStatusScreen extends StatefulWidget {
  final Object? argument;
  const EndMyStatusScreen({Key? key, this.argument}) : super(key: key);
  @override
  State<EndMyStatusScreen> createState() =>
      _endMyStatusScreenState();
}

class _endMyStatusScreenState extends State<EndMyStatusScreen> {
