  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case AppPageNames.notactiveScreen:
        return MaterialPageRoute(builder: (_) =>  Active());
      case AppPageNames.setUpCityScreen:
        return MaterialPageRoute(builder: (_) =>  Selectcityapp());
      case AppPageNames.homeNavigatorScreen:
        return MaterialPageRoute(builder: (_) =>  HomeNavigatorScreen());
      ...
      case AppPageNames.addproductScreen:
        return MaterialPageRoute(builder: (_) =>  AddMyproductScrean());
      case AppPageNames.detailproductScreen:
        return MaterialPageRoute(builder: (_) =>  DetailproductScreen(argument: argument));
      ...
      case AppPageNames.DetailMyproductScrean:
        return MaterialPageRoute(builder: (_) =>  MyProductScreen());
      ...
      case AppPageNames.addStatusScreen:
        return MaterialPageRoute(builder: (_) =>  AddstatusScrean());
      case AppPageNames.addPatientScreen:
        return MaterialPageRoute(builder: (_) =>  AddpatientScrean());
      case AppPageNames.searchPersontScreen:
        return MaterialPageRoute(builder: (_) =>  FindPersonScrean());
      case AppPageNames.endStatusScreen:
        return MaterialPageRoute(builder: (_) =>  EndStatusDoctorsScreen());
      case AppPageNames.needloginScreen:
        return MaterialPageRoute(builder: (_) =>  NeedloginScrean());
