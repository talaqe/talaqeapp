...
class _SignupWidgetState extends State<Signup> {
 ...
 String options="f";
  ...
  University _selecteduniversity=new University(0,"الجامعة",0);
  bool hidePassword = true;

  List<Typetreatment> _typetreatments=[] ;
  Typetreatment _selectedtypetreatment=new Typetreatment(0,"نوع المعالجة","");
  Years years=Years('primary',"السنة ");
  TextEditingController name = new TextEditingController();
  TextEditingController phone = new TextEditingController();
  TextEditingController cityid = new TextEditingController();
  TextEditingController universityid = new TextEditingController();
  TextEditingController typeid = new TextEditingController();
...
bool isfile=false;
                            ...
                            children: [   Radio(
                              ...
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  onPrimary: Color(0xFF6F1CE6),
                                ),
                                onPressed: () {
                                  showdialogtext(context);

                                }, child:   Text('الموافقة على شروط التسجيل',style:TextStyle( fontFamily: 'exar',)),
                              ),
                          ...
                          child: !isfile
                            ...
                            child:Row(
                                children: [
                                  ...
                                  SizedBox(width:2),
                                  Text("ارفاق اثبات هوية",style:TextStyle( fontFamily: 'exar',))
                                ]
                            ),
                          ):Column(
                              children:[
        ...
        if (body['success'] ==true) {
          ...
          if (kIsWeb) {
            ...
            final Uri _url = Uri.parse(
                'https://talaqe.org/api/uploadimg/' + id.toString() + '/signupimg');
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            margin: EdgeInsets.all(20.0),
                            child: Center(
                              child: Text(text,style:TextStyle( fontFamily: 'exar',)),
                            ),
  ...
  List<PopupMenuItem<int>> getyearslist() {
    ...
    List<Years> yearslist = [
      new Years('primary','السنة الاولى'),
      new Years('primary','السنة الثانية'),
      new Years('primary','السنة الثالثة'),
      new Years('primary',' السنة الثالثة سريري'),
      new Years('forth',' السنة الرابعة'),
      new Years('fifth','  السنة الخامسة'),
      new Years('excellent',' امتياز'),
      new Years('master','ماستر '),
      new Years('primary','عيادة خاصة '),
    ];
  ...
  List<PopupMenuItem<int>> getuniversitylist() {
    ...
    if(_selectedcities.id==0){
      list.add(PopupMenuItem<int>(child: Text("الرجاء اختيار المدينة اولا",style:TextStyle( fontFamily: 'exar',))));
    }
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            margin: EdgeInsets.all(20.0),
                            child: Center(
                              child: Text(textt,style:TextStyle( fontFamily: 'exar',)),
                            ),
