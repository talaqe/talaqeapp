...
import '../CallApi.dart';
  ...
  class _Addstatus extends State<AddstatusScrean> {
    ...
    List<Widget> wlist=[];
    String toothss="0";
    List<TextEditingController>   notess =[new TextEditingController()];
    ...
    TextEditingController  numbertooth=new TextEditingController();
                                ...
                                Row(
                                  children: [
                                    Text(_selectedpetient.name,
                                      style: TextStyle( fontFamily: 'exar',fontSize: 14, color: Color(0xFF464545)),),
                                    SizedBox(width: 10,),
...
void showdialogfail(BuildContext context){
  showDialog<void>(
    ...
    List<PopupMenuItem<int>> gettreatmentlist() {
      List<PopupMenuItem<int>> list = [];
      _typetreamtlist.forEach((element) {
        list.add(
          PopupMenuItem<int>(
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
