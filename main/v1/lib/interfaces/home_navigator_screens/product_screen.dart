...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Future<void> fetchPagewithprice(int pageKey,int low,int high) async {
    ...
    print('respone idtreatment  '+low.toString());
    var response=await CallApi().getallData("getproductsprice/"+dentist.id.toString()+"/"+pageKey.toString()+"/"+low.toString()+"/"+high.toString());
    var body = json.decode(utf8.decode(response.bodyBytes));
    print('respone fetchPagewithtrat  '+body.toString());
  ...
  Future<void> fetchPagewithcity(int pageKey,int idcity) async {
    ...
    var response=await CallApi().getallData("getproductscity/"+dentist.id.toString()+"/"+pageKey.toString()+"/"+idcity.toString());
    var body = json.decode(utf8.decode(response.bodyBytes));
    ...
    print('respone _statuseslist  '+_productlist.length.toString());
  ...
  Future<void> fetchPagewithsearch(int pageKey,String text) async {
    ...
    print('respone pageKeytext  '+pageKey.toString());
    var response=await CallApi().getallData("getproductsreach/"+dentist.id.toString()+"/"+pageKey.toString()+"/"+text);
    var body = json.decode(utf8.decode(response.bodyBytes));
    print('respone statuslist  '+body.toString());
    List<dynamic> statuslist=body;
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    response = await CallApi().getallData("getproducts/" +dentist.id.toString()+"/"+ pageKey.toString());
      ...
      body: CustomScaffoldBodyWidget(
        ...
        children: [
          ...
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Text(' المنتجات ', style: AppComponents.headerTextStyle),
