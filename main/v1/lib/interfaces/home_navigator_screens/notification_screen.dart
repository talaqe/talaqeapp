...
class _NotificationScreenState extends State<NotificationScreen> {
 ...
 bool login=false;
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    print('respone getnotificationss  '+pageKey.toString());
    var response=null;

    response = await CallApi().getallData("getnotificationss/" + dentist.city.toString()+"/" +dentist.university.toString()+"/" +dentist.id.toString()+"/" + pageKey.toString());

    var body = json.decode(utf8.decode(response.bodyBytes));
    print('myyyyyyyyy'+body.toString());
    if(body.toString()!="") {
      ...
      setState(() {
        ...
        print('respone _Notificationlist  ' + _Notificationlist.length.toString());
      });
      SharedPreferences prefsssss = await SharedPreferences.getInstance();
  ...
  Widget build(BuildContext context) {
    ...
    if(login) {
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => MYHomeDoctorsScreen(),
          ));
    }
                },
      ...
      body: CustomScaffoldBodyWidget(
        ...
        children: [
          ...
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Text(' الإشعارات ', style: AppComponents.headerTextStyle),
