...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getData() async {
    ...
    if (datastring != "") {
     ...
     if(login) {
      ...
      print('respone banners  '+body3.toString());
  ...
  Future<void> fetchPagewithtrat(int pageKey,int idtreatment,int cityid) async {
    ...
    var response=await CallApi().getallData("getstatusss_withtreat_city/"+pageKey.toString()+"/"+idtreatment.toString()+"/"+cityid.toString());
    var body = json.decode(utf8.decode(response.bodyBytes));
    print('respone fetchPagewithtrat  '+body.toString());
  ...
  Future<void> fetchPagewithcity(int pageKey,int idcity) async {
    ...
    var response=await CallApi().getallData("getstatusss_withcity/"+pageKey.toString()+"/"+idcity.toString());
    var body = json.decode(utf8.decode(response.bodyBytes));
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    response = await CallApi().getallData("getstatusss/" + pageKey.toString());
        ...
        title: login? Container(
          ...
          child: Row(
            ...
            children: [
              ...
              child:
              Text("قم بتسجيل الدحول للاطلاع على كامل خدماتنا ",
